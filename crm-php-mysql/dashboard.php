...
$clientesPorciudad = obtenerClientesPorciudad();
...
<script>
    const clientesPorciudad = <?php echo json_encode($clientesPorciudad) ?>;
    ...
    new Chart($grafica, {
        ...
        data: {
            labels: clientesPorciudad.map(dato => dato.ciudad),
            datasets: [{
                data: clientesPorciudad.map(dato => dato.conteo), // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
